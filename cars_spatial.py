...
trainset    = torchvision.datasets.ImageFolder(root='/data/xushuai/birds/train', transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=32, shuffle=True, num_workers=4)


#testset = torchvision.datasets.ImageFolder(root='./test', transform=transform_test)

testset = torchvision.datasets.ImageFolder(root='/data/xushuai/birds/test', transform=transform_test)
